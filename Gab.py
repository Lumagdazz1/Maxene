...
def GabxTools():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("==================================================")
      print(f" [=] ₱ 100 24 Hours")
      print(f" [=] ₱ 200 48 Hours ")
      print(f" [=] ₱ 1100 For Personal Use / Open Source")
      print("==================================================")
      print(f" [=] YOUR KEY NOT APPROVED")
      print(f" [=] SEND KEY FOR ACCESS THIS TOOL")
      print(f" [=] AUTOMATIC DERICK TO ADMIN IN 15 SECOND"); time.sleep(15)
      print("==================================================")
      os.system(f'xdg-open https://www.facebook.com/mark.masaya.2024')
      time.sleep(6)
      sys.exit()
  except:
    sys.exit()
    ...
    if id:
        ...
        if 'Locked' in check:
            ...
            if code:
                ...
                print(c)
                oks.append(id)
                open("/sdcard/AUTO-CREATE/create/alive.txt", "a").write(id+"|"+code+f"|{password}|"+email+"|"+token+"\n")
            else:
                print()
    else:
        open("/sdcard/AUTO-CREATE/create/disabled-cp.txt", "a").write(f"{email}|{id}|GabxPOGIJOKER123\n")
        cps.append(id)
